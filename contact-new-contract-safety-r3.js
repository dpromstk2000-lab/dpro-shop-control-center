(() => {
  ...
  const BUILD = "DPRO-CONTACT-NEW-CONTRACT-SAFETY-R3-20260815";
  const PACKAGE_VERSION = "DPRO-CONTACT-NEW-CONTRACT-SAFETY-R3-20260815";
  ...
  function setupInfo(p) {
    return [
      ...
      "3. WEB利用時はWEB DB拡張を確認",
      "4. 添付利用時は添付テーブル + private Storage bucketを確認",
      "5. Cloudflareログイン後、Deploy直前に中央PACKAGE CURRENTをもう一度確認",
      "6. 上記PASS後にのみCloudflareへDeploy",
      "7. 不足SecretだけWranglerの安全入力で登録",
      "8. /api/health確認",
      "",
      "【重要】",
