(() => {
  ...
  function installStyle() {
    ...
    style.textContent=`
      ...
      .c10-head h2{margin:0;font-size:23px}.c10-head p{margin:6px 0 0;color:#68766f;font-size:10px;line-height:1.7}
      .c10-guide{padding:13px 15px;border:1px solid #b9dccd;border-radius:13px;background:#eef9f4;color:#486159;font-size:10px;line-height:1.7}
      .c10-safety{margin-top:8px;padding:12px 14px;border:1px solid #ead18b;border-radius:12px;background:#fff9e9;color:#805c00;font-size:9px;line-height:1.65}
      .c10-summary{display:grid;grid-template-columns:repeat(7,minmax(0,1fr));gap:8px;margin:12px 0}.c10-metric{padding:12px;border:1px solid #d9e5e0;border-radius:13px;background:#fff}.c10-metric b,.c10-metric span{display:block}.c10-metric b{font-size:20px;color:#0b5f49}.c10-metric span{font-size:8px;color:#6b7974;margin-top:3px}.c10-metric.warn b{color:#956200}.c10-metric.bad b{color:#b63247}
      .c10-tools{display:grid;grid-template-columns:minmax(260px,1fr) 220px auto;gap:8px;margin:10px 0}.c10-tools input,.c10-tools select{min-height:42px;border:1px solid #d8e4df;border-radius:10px;background:#fff;padding:0 11px}
      ...
      .c10-main small,.c10-main strong,.c10-main span{display:block}.c10-main small{font-size:8px;color:#6d7b75;font-weight:900}.c10-main strong{margin-top:3px;font-size:13px}.c10-main span{margin-top:3px;font-size:8px;color:#6d7b75}.c10-cell b,.c10-cell span{display:block}.c10-cell b{font-size:9px}.c10-cell span{margin-top:3px;font-size:8px;color:#6f7e78}
      .c10-pill{display:inline-flex;padding:5px 8px;border-radius:999px;background:#eef2f0;color:#61706a;font-size:8px;font-weight:900}.c10-pill.green{background:#def5ea;color:#087253}.c10-pill.amber{background:#fff2cf;color:#936300}.c10-pill.red{background:#fee8ed;color:#b63247}.c10-pill.blue{background:#edf6ff;color:#246ba9}.c10-pill.gray{background:#edf0ef;color:#69756f}
      .c10-empty{padding:30px;text-align:center;border:1px dashed #c5d4cd;border-radius:14px;background:#fff;color:#6d7b75}.c10-empty strong{display:block;font-size:14px;color:#20312b}.c10-empty span{display:block;margin-top:7px;font-size:9px;line-height:1.7}
      .c10-detail{margin-top:13px}.c10-hero{padding:17px;border-radius:16px;background:linear-gradient(135deg,#0b5f49,#073d31);color:#fff;display:flex;justify-content:space-between;gap:14px}.c10-hero small,.c10-hero strong,.c10-hero span{display:block}.c10-hero small{color:#bde4d6;font-size:8px;font-weight:900}.c10-hero strong{margin-top:4px;font-size:20px}.c10-hero span{margin-top:4px;color:#cde8de;font-size:9px}.c10-hero-status{height:max-content}
      .c10-section{margin-top:10px;padding:15px;border:1px solid #d9e5e0;border-radius:15px;background:#fff}.c10-section h3{margin:0;font-size:14px}.c10-section>p{margin:5px 0 11px;color:#6c7a74;font-size:9px;line-height:1.6}
      .c10-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.c10-field{display:grid;gap:5px}.c10-field.full{grid-column:1/-1}.c10-field label{font-size:8px;font-weight:900;color:#61706a}.c10-field input,.c10-field select,.c10-field textarea{min-height:40px;border:1px solid #d8e4df;border-radius:9px;background:#fff;padding:0 9px;font-size:9px}.c10-field textarea{min-height:76px;padding:9px;resize:vertical}
      .c10-features{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:7px}.c10-feature{padding:10px;border:1px solid #e0e8e4;border-radius:11px;background:#fbfcfb}.c10-feature.changed{border-color:#9fceb9;background:#f7fcf9}.c10-feature-head{display:flex;gap:7px;align-items:flex-start}.c10-feature-head input{width:18px;height:18px;accent-color:#0b5f49}.c10-feature strong{display:block;font-size:9px}.c10-feature small{display:block;margin-top:2px;color:#74817c;font-size:8px}.c10-feature textarea{width:100%;margin-top:7px;min-height:45px;border:1px solid #dce5e1;border-radius:8px;padding:7px;font-size:8px;resize:vertical}
      .c10-service-row{display:grid;grid-template-columns:minmax(170px,1fr) 120px 110px 130px 130px auto;gap:7px;margin-top:7px;align-items:center}.c10-service-row select,.c10-service-row input{min-height:38px;border:1px solid #d8e4df;border-radius:8px;background:#fff;padding:0 8px;font-size:8px}
      .c10-checklist{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:7px}.c10-check{display:flex;gap:8px;align-items:flex-start;padding:10px;border:1px solid #e0e8e4;border-radius:10px}.c10-check input{width:17px;height:17px;accent-color:#0b5f49}.c10-check strong{font-size:9px}.c10-check small{display:block;margin-top:3px;color:#74817c;font-size:8px}
      .c10-flow{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:6px;margin-top:10px}.c10-step{padding:9px;border:1px solid #e0e8e4;border-radius:10px;background:#f8faf9;text-align:center;font-size:8px;font-weight:900}.c10-step.current{border-color:#8bc7ae;background:#eaf7f1;color:#087253}.c10-step.done{background:#def5ea;color:#087253}
      .c10-actions{display:flex;justify-content:flex-end;gap:8px;flex-wrap:wrap;margin-top:11px}.c10-history-task{display:grid;grid-template-columns:110px 130px minmax(0,1fr) 110px;gap:8px;align-items:center;padding:9px;border:1px solid #e3eae7;border-radius:9px;margin-top:6px;font-size:8px}
      .c10-modal{position:fixed;inset:0;z-index:3000;background:rgba(3,31,24,.55);display:grid;place-items:center;padding:20px}.c10-modal.hidden{display:none}.c10-modal-card{width:min(760px,96vw);max-height:90vh;overflow:auto;background:#fff;border-radius:18px;padding:20px;box-shadow:0 24px 80px rgba(0,0,0,.25)}.c10-modal-head{display:flex;justify-content:space-between;gap:12px}.c10-modal-head h2{margin:0;font-size:20px}.c10-close{border:0;background:#eef3f0;border-radius:9px;width:36px;height:36px;cursor:pointer}
