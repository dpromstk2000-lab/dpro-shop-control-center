...
window.DPRO_CONTACT_CONFIG = Object.freeze({
  version: "DPRO-CONTACT-1-FRONTEND-LINE-WEB-INSTAGRAM-20260830-R2-PUSH-STAGED",
...
(() => {
  ...
  if (!document.querySelector('script[data-dpro-reply-alert-r1]')) {
    const script = document.createElement("script");
    script.src = "contact-v1-notification-r1.js?v=DPRO-CONTACT-REPLY-ALERT-R2-20260830";
    script.defer = true;
